...
g_sCmdDesc: str = "Runs VSCode related Catharsys commands"
...
def RunCmd(_argsCmd, _lArgs):
    ...
    args.RunCmdGroup(_argsCmd=_argsCmd, _lArgs=_lArgs, _sCommandGroupName="catharsys.commands.code")
...
def RunCli():
    ...
    try:
        ...
        except_util.PrintException(xEx=xEx, bTraceback=xArgs.debug)
        sys.exit(1)
    # endtry
