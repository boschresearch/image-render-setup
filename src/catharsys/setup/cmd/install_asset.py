...
g_sCmdDesc = "Installs Catharsys asset"


####################################################################
def AddArgParseArguments(_xArgParser):
    _xArgParser.add_argument("asset_name", nargs="?", default=None)
    ...
    _xArgParser.add_argument(
        "--list", dest="do_list", action="store_true", default=False
    )
...
def RunCmd(_argsCmd, _lArgs):
    from . import install_asset_impl as impl
    ...
    impl.Run(
        sAssetName=argsSubCmd.asset_name,
